...
function Reset(){
  ColourImage.src = `assets/Void.png`;
  HatImage.src = `assets/Void.png`;
  PantImage.src = `assets/Void.png`;

  ColourImageSingle.src = `assets/Void.png`;
  HatImageSingle.src = `assets/Void.png`;
  PantImageSingle.src = `assets/Void.png`;
}
